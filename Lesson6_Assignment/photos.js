...
function previewFive(){
  ...
  //create fugure and img elements for 5th image
  ...
  //articleEl.insertBefore(lastFigure, document.getElementById)
  ...
  //clone figure element for 5th image and edit it to be first image 
  ...
  // add appropriate src values to two new image elements
